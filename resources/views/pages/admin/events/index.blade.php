        ...
        <div style="padding: 12px 16px; border-bottom: 1px solid var(--border); display: none;" id="bulkDeleteContainer">
            <button type="submit" class="btn btn-danger btn-sm">
                <svg fill="none" viewBox="0 0 24 24" width="14" height="14">
                    ...
                    <path d="M19 6l-1 14H6L5 6M10 11v6M14 11v6M9 6V4a1 1 0 011-1h4a1 1 0 011 1v2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $imgUrl = filter_var($gambar, FILTER_VALIDATE_URL)
                            ? $gambar
                            : asset('storage/' . $gambar);
                            @endphp

                            @if($gambar)
                            <img src="{{ $imgUrl }}" alt="{{ $event->judul }}" class="event-thumb" style="max-width: 60px; border-radius: 4px; object-fit: cover;">
                            @else
                            <div class="event-thumb-placeholder" style="width: 60px; height: 60px; background: #f3f4f6; display: flex; align-items: center; justify-content: center; border-radius: 4px;">
                                <svg fill="none" viewBox="0 0 24 24" width="24" height="24">
                                    <path d="M9 19V6l12-3v13M9 19c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm12-3c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z" stroke="#9ca3af" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            @endif
                        </td>
