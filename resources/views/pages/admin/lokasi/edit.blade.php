...
@section('breadcrumb', 'Edit Lokasi')
...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Ubah informasi master data lokasi</p>
    </div>
    <div>
    ...
    <form action="{{ route('admin.lokasi.update', $lokasi) }}" method="POST">
        ...
        <div style="padding: 24px;">
            <div class="form-group">
                ...
                <input type="text" name="nama_lokasi" class="form-control {{ $errors->has('nama_lokasi') ? 'border-danger' : '' }}" value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}" required>
            ...
            <div class="form-group">
                ...
                <select name="aktif" class="form-control {{ $errors->has('aktif') ? 'border-danger' : '' }}" required>
                    <option value="Y" {{ old('aktif', $lokasi->aktif) == 'Y' ? 'selected' : '' }}>Aktif</option>
                    <option value="N" {{ old('aktif', $lokasi->aktif) == 'N' ? 'selected' : '' }}>Non-Aktif</option>
                </select>
