                ...
                <a href="{{ route('events.show', $event) }}"
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <div class="mt-auto flex items-center justify-between pt-3 border-t border-outline-variant">
                            ...
                            <span class="bg-surface-variant text-on-surface-variant px-4 py-2 rounded-lg font-button-text text-sm cursor-not-allowed" title="Lokasi sedang tidak aktif">
                                Tutup
                            </span>
                            @elseif($totalStok < 1)
                                <span class="bg-error text-on-error px-4 py-2 rounded-lg font-button-text text-sm cursor-not-allowed" title="Tiket Habis Terjual">
                                Sold Out
                                </span>
                                @else
